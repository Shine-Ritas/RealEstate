<section class="relative py-12 md:py-20 overflow-hidden">
    <div class="container mx-auto px-4 md:px-6 lg:px-8">
        <div class="relative">
            ...
            <!-- Search Box -->
            <div class="absolute top-4 left-4 right-4 sm:right-auto sm:w-80 z-10">
                <div class="relative">
                    <input
                        id="searchBox"
                        type="text"
                    ...
                    />
                    <i class="fa fa-solid fa-search absolute left-3 top-1/2 -translate-y-1/2 text-on-surface-variant"></i>
                    <button
                        id="clearSearchBtn"
                        onclick="clearSearch()"
