<x-layouts.auth>
    <div class="flex flex-col items-center gap-8 w-full">
        ...
        <div class="flex flex-col items-center text-center gap-2">
            <h1 class="text-3xl font-bold text-on-surface font-barlow-condensed">{{ __('Create an account') }}</h1>
            <p class="text-on-surface-variant">{{ __('Enter your details below to create your account') }}</p>
        </div>
        ...
        <div class="auth-card w-full max-w-md">
            <form method="POST" action="{{ route('register.store') }}" class="flex flex-col gap-6">
                ...
                <flux:button type="submit" variant="primary" class="w-full flex items-center justify-center gap-2" data-test="register-user-button">
