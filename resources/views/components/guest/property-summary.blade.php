<div class="bg-white dark:bg-surface-variant rounded-xl p-6 md:p-8 border border-outline sticky top-4">
    ...
    <div class="grid grid-cols-3 gap-4 mb-6 pb-6 border-b border-outline">
        <div class="text-center">
            ...
            <p class="text-sm text-on-surface-variant">Bedrooms</p>
        ...
        <div class="text-center">
            ...
            <p class="text-sm text-on-surface-variant">Bathrooms</p>
    ...
    <div class="space-y-3 mb-6">
        <div class="flex justify-between">
            <span class="text-on-surface-variant">Property Code:</span>
            <span class="font-semibold text-on-surface">{{ $propertyCode ?? '#TH2024001' }}</span>
        </div>
        <div class="flex justify-between">
            <span class="text-on-surface-variant">Floor:</span>
